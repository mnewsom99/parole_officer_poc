                ...
                {appointments.length > 0 ? (
                    appointments.map(event => (
                        <div
                            ...
                            className={`bg-white p-3 rounded-lg shadow-sm border border-slate-200 border-l-4 cursor-pointer hover:shadow-md transition-shadow ${getAppointmentStyle(event.type, appointmentSettings).border}`}
                        ...
                        >
                            <div className="flex justify-between items-start mb-1">
                                ...
                                <span className="text-[10px] uppercase font-bold text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded">{event.type || 'Visit'}</span>
                            </div>
